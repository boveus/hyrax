  ...
  describe "#delete" do
    ...
    context "when it succeeds" do
      it "redirects to My Collections" do
        ...
        expect(flash[:notice]).to eq "Collection '#{collection.title.first}' was successfully deleted"
      end
    ...
    context "when an error occurs" do
      ...
      it "renders the edit view" do
        ...
        expect(response).to render_template(:edit)
        expect(flash[:notice]).to eq "Collection '#{collection.title.first}' could not be deleted"
      end
